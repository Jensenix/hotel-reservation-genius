    ...
    <div className="container mx-auto px-4 max-w-7xl w-full">
      <div className="text-center mb-12 sm:mb-20">
        ...
        <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
          Take a visual journey through our exquisite spaces and discover the
          elegance that awaits your arrival
        </p>
      </div>
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-slate-200 to-slate-300 flex items-center justify-center p-2">
              <div className="text-center">
                ...
                <p className="text-slate-700 font-semibold tracking-wide uppercase text-[10px] sm:text-sm truncate w-full px-1">
                  {item}
                </p>
              </div>
            </div>
