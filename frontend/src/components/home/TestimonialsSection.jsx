    ...
    <div className="container mx-auto px-4 max-w-7xl w-full">
      <div className="text-center mb-12 sm:mb-20">
        <div className="flex items-center justify-center space-x-2 sm:space-x-3 mb-6 sm:mb-8">
          ...
          <span className="text-amber-600 text-xs sm:text-sm font-semibold tracking-widest uppercase">Guest Voices</span>
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-800 mb-6 sm:mb-8 tracking-tight break-words">
          What Our <span className="font-semibold text-amber-600 block sm:inline">Guests Say</span>
        </h2>
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div className="text-center sm:text-left">
              <p className="text-slate-800 font-semibold text-base sm:text-lg mb-1 sm:mb-2">{testimonial.name}</p>
              <p className="text-slate-500 text-xs sm:text-sm font-light">{testimonial.title}</p>
            </div>
          </div>
        ))}
      </div>
