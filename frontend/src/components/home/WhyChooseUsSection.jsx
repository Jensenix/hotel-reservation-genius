    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-24">
        ...
        <h2 className="text-5xl font-light text-slate-800 mb-8 tracking-tight">
          The{' '}
          <span className="font-semibold text-amber-600">Genius Society</span>{' '}
          Experience
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        <div className="text-center group">
          ...
          <p className="text-slate-600 leading-relaxed font-light text-lg">
            Experience world-class facilities and premium services designed for
            your ultimate comfort and relaxation beyond imagination
          </p>
        </div>
        ...
        <div className="text-center group">
          ...
          <p className="text-slate-600 leading-relaxed font-light text-lg">
            Located in the heart of the city with exclusive access to premier
            attractions, business districts, and entertainment venues
          </p>
        </div>
        ...
        <div className="text-center group">
          ...
          <p className="text-slate-600 leading-relaxed font-light text-lg">
            ...
            with personalized attention to every detail and desire
          </p>
        </div>
      </div>
    </div>
