    ...
    <div className="container mx-auto px-4 max-w-7xl">
      <div className="text-center mb-12 sm:mb-20">
        ...
        <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
          Indulge in our exceptional amenities designed to elevate your stay to
          extraordinary heights of luxury and comfort
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 w-full">
        <div className="group text-center">
          ...
          <h3 className="text-xl sm:text-2xl font-light text-slate-800 mb-3 sm:mb-4 tracking-tight">
            High-Speed WiFi
          </h3>
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed font-light">
            Complimentary ultra-high speed internet throughout the entire hotel
            premises
          </p>
        </div>
        ...
        <div className="group text-center">
          ...
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed font-light">
            Award-winning restaurant serving exquisite international cuisine by
            master chefs
          </p>
        </div>
