...
export default function BookingDetailModal({ isOpen, onClose, selectedBooking, bookingDetails, loadingDetails, getStatusBadge }) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
    ...
    >
      {loadingDetails ? (
        ...
        <div className="text-center py-8 text-gray-600">No booking details available</div>
      )}
    </Modal>
  );
}