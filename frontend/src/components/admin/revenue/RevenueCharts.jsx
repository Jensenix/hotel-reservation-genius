 ...
 * @param {Array<Object>} props.revenueData.revenueByMonth
          ...
          revenueData.revenueByRoomType.length > 0 ? (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">
                    {item.bookings > 0
                      ? formatCurrency(Math.round(item.revenue / item.bookings))
                      : formatCurrency(0)}{' '}
                    avg
                  </p>
                </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-xs text-slate-400">
                Try adjusting the payment date range or check if there are paid
                bookings
              </p>
            </div>
          )}
