...
export default function BookingActionModal({
  isOpen, onClose, actionType, selectedBooking, cancelReason, setCancelReason, executeAction
}) {
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-end space-x-3">
          ...
          <Button
            ...
            className={actionType === 'cancel' ? 'bg-red-600 hover:bg-red-700 text-white border-none' : ''}
          >
            {actionType === 'cancel' ? 'Yes, Cancel Booking' : title.split(' Booking')[0]}
          </Button>
        </div>
      </div>
    </Modal>
