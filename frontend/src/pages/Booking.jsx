...
const Booking = () => {
  ...
  const [showExtraServicesDropdown, setShowExtraServicesDropdown] =
    useState(false);
      ...
      const fetchBookingDetails = async () => {
        try {
          ...
          if (booking.room && booking.checkInDate && booking.checkOutDate) {
            ...
            const roomPrice =
              nights *
              (booking.room.roomType?.basePrice || booking.room.basePrice || 0);
            ...
            if (booking.extraServices && booking.extraServices.length > 0) {
              booking.extraServices.forEach((service) => {
                servicesTotal += parseFloat(
                  service.BookingExtraService?.subtotal || service.price || 0,
                );
              });
            }
          ...
          if (booking.extraServices && booking.extraServices.length > 0) {
            ...
            booking.extraServices.forEach((service) => {
              servicesMap[service.id] =
                service.BookingExtraService?.quantity || 1;
            });
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !event.target.closest('.extra-services-dropdown')
      ) {
    ...
    if (step === 1 && validateStep1()) {
      ...
      try {
        ...
        const bookingResponse =
          await apiService.bookings.create(bookingPayload);
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center">
            ...
            <div
              className={`w-16 h-1 mx-4 ${step >= 2 ? 'bg-blue-600' : 'bg-gray-300'}`}
            ></div>
            <div
            ...
            <Card>
                  ...
                  {bookingId ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6">
                        You have a pending booking. Click "Continue to Payment"
                    ...
                    <>
                          ...
                          <div className="flex items-center space-x-4">
                            <div className="flex items-center border border-gray-300 rounded-lg">
                              ...
                              <button
                                ...
                                onClick={() => {
                                  if (
                                    bookingData.guestCount < room.maxCapacity
                                  ) {
                                    setBookingData((prev) => ({
                                      ...prev,
                                      guestCount: prev.guestCount + 1,
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs text-gray-500">
                          Examples: Late check-in, early check-out, room
                          preferences, dietary requirements, etc.
                        </p>
                      </div>
                        ...
                        <div className="relative extra-services-dropdown">
                          ...
                          >
                            <span className="text-gray-900">
                              {Object.keys(selectedExtraServices).filter(
                                (id) => selectedExtraServices[id] > 0,
                              ).length > 0
                          ...
                          {showExtraServicesDropdown && (
                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                              {extraServices.map((service) => {
                                const quantity =
                                  selectedExtraServices[service.id] || 0;
                                return (
                                  <div
                                    key={service.id}
              ...
              <div className="flex justify-between mt-8">
                ...
                <Button
                  ...
                  disabled={
                    step === 1
                      ? !validateStep1() || isProcessingPayment
                      : !validateStep2() || isProcessingPayment
                  }
                  className="ml-auto"
                >
                  {isProcessingPayment
