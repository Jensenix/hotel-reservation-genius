        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <span className="text-amber-600 text-xs font-semibold tracking-widest uppercase">Luxury Stays</span>
            ...
            <h2 className="text-5xl font-light text-slate-800 mb-6 tracking-tight">
              Exquisite <span className="font-semibold text-amber-600">Accommodations</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
              Indulge in our meticulously curated rooms and suites, where every detail speaks the language of sophisticated luxury and unparalleled comfort
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredRooms.map((room) => (
                <div key={room.id} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 border border-slate-100">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-amber-600 font-semibold tracking-wide uppercase text-sm">Room {room.id}</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-8">
                    <h3 className="text-2xl font-light text-slate-800 mb-3 tracking-tight">{room.name}</h3>
                    <p className="text-slate-600 leading-relaxed mb-6 font-light">
                      {room.description || 'Experience the epitome of luxury with our meticulously designed accommodations featuring premium amenities and breathtaking views'}
                    </p>
                    
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center text-slate-600">
                        <Users className="w-5 h-5 mr-3 text-amber-500" />
                        <span className="text-sm">Up to {room.capacity || 2} Guests</span>
                      </div>
                      <div className="flex items-center text-slate-600">
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                      <div>
                        <p className="text-3xl font-light text-slate-800">${room.basePrice}</p>
                        <p className="text-sm text-slate-500 font-light">per night</p>
                      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div className="group text-center">
              ...
              <p className="text-slate-600 leading-relaxed font-light">Complimentary ultra-high speed internet throughout the entire hotel premises</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-slate-600 leading-relaxed font-light">Award-winning restaurant serving exquisite international cuisine by master chefs</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-slate-600 leading-relaxed font-light">State-of-the-art gym with premium equipment and personal trainers</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-slate-600 leading-relaxed font-light">Secure valet parking service available 24/7 with concierge assistance</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 via-amber-50/10 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-24">
            <div className="flex items-center justify-center space-x-3 mb-8">
              <div className="w-16 h-0.5 bg-gradient-to-r from-transparent to-amber-500"></div>
              <span className="text-amber-600 text-sm font-semibold tracking-widest uppercase">The Genius Difference</span>
              <div className="w-16 h-0.5 bg-gradient-to-l from-transparent to-amber-500"></div>
            </div>
            <h2 className="text-5xl font-light text-slate-800 mb-8 tracking-tight">
            ...
            {[
              {
                ...
                content: "Absolutely exceptional! The attention to detail and service excellence exceeded all expectations. This is luxury redefined.",
                rating: 5
              },
              {
                name: "Sophia Martinez",
                title: "Award-Winning Designer",
                content: "Every moment was perfection. The blend of elegance and comfort creates an unforgettable experience that lingers in memory.",
                rating: 5
              },
              {
                name: "James Chen",
                title: "International Diplomat",
                content: "Outstanding in every aspect. The staff anticipates needs before they arise. True five-star excellence in hospitality.",
                rating: 5
              }
            ].map((testimonial, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 border border-slate-100">
