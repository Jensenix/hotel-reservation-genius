...
const Login = () => {
  const { formData, loading, error, handleChange, handleSubmit, fillDemoCredentials } = useLogin();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-8 relative overflow-hidden">
          ...
          <AuthHeader title="Welcome" highlight="Back" subtitle="Genius Society Hotel Portal" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#reset" className="text-sm text-amber-600 hover:text-amber-500 transition-colors">
                Forgot password?
              </a>
            </div>
