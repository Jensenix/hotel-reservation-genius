    ...
    <AdminLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50">
        ...
        {/* Overall Statistics */}
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl shadow-lg p-6 border border-slate-700 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-3xl font-light text-white">{availabilityData.overall.totalRooms}</p>
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-xl shadow-lg p-6 border border-emerald-500 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-3xl font-light text-white">{availabilityData.overall.availableRooms}</p>
              <p className="text-sm text-emerald-100 mt-1">{availabilityData.overall.availabilityRate}% available</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl shadow-lg p-6 border border-slate-600 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-3xl font-light text-white">{availabilityData.overall.occupiedRooms}</p>
              <p className="text-sm text-slate-400 mt-1">{availabilityData.overall.occupancyRate}% occupied</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-600 to-amber-700 rounded-xl shadow-lg p-6 border border-amber-500 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-3xl font-light text-white">{availabilityData.overall.maintenanceRooms}</p>
        ...
        <div className="space-y-6">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-slate-800 mb-1">Availability by Room Type</h2>
            <p className="text-sm text-slate-500">Detailed room status by category</p>
          </div>
          
          {availabilityData.byRoomType.map((roomType) => (
            <div key={roomType.roomTypeName} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div 
                className="flex items-center justify-between cursor-pointer"
                onClick={() => setExpandedRoomType(expandedRoomType === roomType.roomTypeName ? null : roomType.roomTypeName)}
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-slate-800">{roomType.roomTypeName}</h3>
                    <p className="text-sm text-slate-500">{roomType.totalRooms} rooms total</p>
                  </div>
                </div>
              ...
              {expandedRoomType === roomType.roomTypeName && (
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {roomType.rooms.map((room) => (
                    <div key={room.id} className="bg-gradient-to-r from-slate-50 to-white border border-slate-100 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
                      <div className="flex items-center justify-between">
                        <div>
